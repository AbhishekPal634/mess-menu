        ...
        >
          ...
          {showSkipButton && (
            <motion.button
              ...
              onClick={handleSkip}
              className="absolute top-4 right-4 bg-gray-800/50 hover:bg-gray-700 text-gray-300 hover:text-white p-3 rounded-full z-50 flex items-center justify-center transition-all duration-300 backdrop-blur-sm border border-gray-700/50"
            >
              <FaTimes className="text-lg" />
              <span className="ml-2 text-sm font-tech tracking-wide">SKIP</span>
            </motion.button>
          )}

          {/* Tech-themed circuit lines */}
